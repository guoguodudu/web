...
class EditSupCon extends React.Component {
    ...
    handleOk = async() => {
        ...
        let result = await supCon.update(data)
        ...
        if(!checkIsNull(result) && !checkIsNull(result.data) && result.data.result === 1){
            ...
            this.state.parent.setState({editSupConVisiable:false})
    ...
    handleCancel = () => {
		...
		this.props.parent.setState({editSupConVisiable:false})
    };
