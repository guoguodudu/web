...
import {checkNull, checkEmpty, sysErrorInfo, errorInfo } from '../../../Common.jsx';

class OrgConfSpanComp extends React.Component {
    ...
    componentWillMount() {
        console.log("-19-----OrgConfSpanComp---componentWillMount---------------",this.props);
    }
    ...
    inputOnBlur = (e) => {
        console.log("---76-------------inputOnBlur------this.props-----",this.props);
        var orgType = this.props.parent.state.orgType;
        console.log("---36-------------inputOnBlur------orgType-----",orgType);
        ...
        console.log("----86-groupCode--------",groupCode);
        ...
        this.props.parent.setState({compCode:e.target.value});
                ...
                <div className="gutter-example">
                    <Row>
                        ...
                        <Col span={10}>
                            ...
                            <Row>
                                <Col span={8}>公司代码： </Col>
                                <Col span={16}><Input size="default" value={this.state.code} onChange={this.handleCode} onBlur={this.inputOnBlur} disabled={this.state.compDisa} /></Col>
                            </Row>
                            <br />
                            <Row>
                                <Col span={8}>公司名称： </Col>
...
export default OrgConfSpanComp;