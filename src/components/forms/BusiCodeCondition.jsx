...
class BusiCodeCondition extends React.Component {
	state = {
	...
	render() {
		return (
			<span>
                ...
                <FormItem label={'商户集团：'}>
                    <Select style={{ width: 180 }} onChange={this.handleBusiGroupCode} value={this.state.busiGroupCode} disabled={this.state.busiGroupDisa}>
                        {this.state.busiGroupCodeList}
                    </Select>
                </FormItem>
                <FormItem label={'商户公司：'}>
                    <Select style={{ width: 180 }} onChange={this.handleBusiCompCode} value={this.state.busiCompCode} disabled={this.state.busiCompDisa} >
                        {this.state.busiCompCodeList}
                    </Select>
                </FormItem>
                <FormItem label={'商户网点：'}>
                    <Select style={{ width: 180 }} onChange={this.handleBusiSiteCode} value={this.state.busiSiteCode} disabled={this.state.busiSiteDisa} >
...
export default BusiCodeCondition;